 ...
 * @description set 'res.reply' function and headers
 */
module.exports = function (app) {
  return function replyMiddleware(req, res, next){
    ...
    function reply(code, response, err){
      ...
      if (typeof code != 'number' && isUndefined(response)) {
        response = code;
        code = 200;
    ...
    if (app.enabled('x-powered-by')) 
      res.setHeader('X-Powered-By', 'Novice1-Express');
